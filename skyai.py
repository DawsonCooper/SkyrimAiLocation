...
def main():
    ...
    print(parentPath)
    images, labels = load_data(parentPath)
    ...
    model.fit(x_train, y_train, epochs=EPOCHS, batch_size=32, callbacks=[tensorboard], validation_split=0.3)
...
def load_data(data_dir):
    ...
    if images and labels:  # Check if lists are not empty
